...
// GET /api/products?intent=<url-encoded JSON> — deterministic catalog
// search used directly by the recommend route, and independently
// testable/curl-able on its own.
